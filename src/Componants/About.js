...
export default function About() {
  ...
  return (
    <div className="text-center md:text-left flex flex-col rounded-lg bg-[#F1F2F4] mt-2 px-6 py-[9%] space-y-6">
      <div className="container mx-auto">
        ...
        >
          ...
          <motion.div
            ...
            className="text-md  font-semibold md:ml-16 md:pr-16 w-full md:w-[55%]"
          >
            <h1 className="text-lg text-slate-800 font-bold">
              Trust House Insurance Company <br />
              (Dar Al Theqa Insurance Company)
            </h1>
            <br />
            <h2 className="">
              a private shareholding, was founded by Iraqi insurance men whom
              ...
              fully paid share capital of IQD 5 000 000 000 in compliance with
              the Insurance Diwan Order concerning insurance companies’ capital
              The company was granted license to carry out insurance activities
              by the Insurance Diwan on 15 03 2010 (License 21 of 2010 We have
              also granted our license in Kurdistan on 29 03 2017 (no 1161).
            </h2>
          </motion.div>
        </motion.div>
      </div>
