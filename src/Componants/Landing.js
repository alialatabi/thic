...
export default function Landing() {
  ...
  return (
    <div className="container mt-36 mb-[73px] flex flex-col px-6 py-10 mx-auto space-y-6 lg:py-16 lg:flex-row lg:items-center justify-center ">
      <div className="sliding-animate-rtl ">
        <div className="lg:max-w-lg">
          ...
          <div className="mt-8 space-y-5">
            <p className="flex items-center -mx-2 text-slate-500 font-bold text-5xl">
              <span className="mx-2 text-[#0A479B]">Your First Choice</span>
            </p>
            <button
